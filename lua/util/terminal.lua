...
-- https://github.com/LazyVim/LazyVim/blob/51854046dbb0bacf690ddc217cc76bf98c8ec1aa/lua/lazyvim/util/terminal.lua
...
function M.setup(shell)
  ...
  if shell == "pwsh" or shell == "powershell" then
    ...
    elseif vim.fn.executable("powershell") == 1 then
      ...
      return vim.notify("No powershell executable found", "error")
    end
